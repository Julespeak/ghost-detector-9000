...
impl Ahrs {
    ...
    pub fn new() -> Ahrs {
        // do all of the calibration and connections from the main function
        ...
        let quaternion_thread = thread::spawn(move || compute_quaternions());

        Ahrs {
            receiver: Some(receiver),
            thread: quaternion_thread,
        }
    }
